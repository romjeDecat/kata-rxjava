...
public class CountriesServiceSolvedTest {
    ...
    @Test
     void rx_CountAmountOfCountries() {
    ...
    @Test
     void rx_ListPopulationOfEachCountry() {
    ...
    @Test
     void rx_ListOnly3rdAnd4thCountry() {
